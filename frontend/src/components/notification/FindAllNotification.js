...
export default function FindAllNotification() {
    ...
    async function fetchNotifications() {
        const url = "http://localhost:8760/notification/fetchallnotifications";
        try {
            ...
            <div className="container py-4" style={{ maxWidth: 900 }}>
                ...
                {data.length === 0 ? (
                    ...
                    >
                        ...
                        <h6 className="fw-semibold mt-3 mb-1" style={{ color: "#334155" }}>No notifications yet</h6>
                            ...
                            return (
                                ...
                                >
                                    <div className="card-body d-flex align-items-start justify-content-between gap-3 p-4">
                                        ...
                                        >
                                            {m.category?.toUpperCase() === "ALERT"    ? "🚨" :
                                             m.category?.toUpperCase() === "REMINDER" ? "⏰" : "ℹ️"}
                                        </div>
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <p className="mb-0" style={{ fontSize: "14px", color: "#334155", lineHeight: 1.6 }}>
                                                {m.message}
                                            </p>
                                        </div>
