...
export default function Login() {
  ...
  const login = (event) => {
    ...
    axios
      .post("http://localhost:9002/api/auth/login", { email, password })
      ...
      >
        <div className="row g-0 h-100">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(160deg, #1a73a7 0%, #0d4f73 100%)",
            }}
          >
            ...
            <div className="d-flex flex-column gap-2 w-100 px-2">
              {["Patient Care", "Staff Management", "Finance & Billing"].map(
                (item) => (
                  <div
                    key={item}
          ...
          <div className="col-md-7 d-flex align-items-center bg-white">
            <div className="w-100 p-4 p-md-5">
              ...
              <div className="d-flex d-md-none align-items-center gap-2 mb-4">
                ...
                <span className="fw-bold" style={{ color: "#1a3c5e" }}>
                  MediServe
                </span>
              </div>
              ...
              <p className="small mb-4" style={{ color: "#5a8fa8" }}>
