...
public class KPIReportResponseDTO {
    ...
    public void setKpiReportScope(String kpiReportScope) {
        this.kpiReportScope = kpiReportScope;
    }
    ...
    public LocalDate getKpiGeneratedDate() {
        return kpiGeneratedDate;
    }

    public void setKpiGeneratedDate(LocalDate kpiGeneratedDate) {
        this.kpiGeneratedDate = kpiGeneratedDate;
    }

    public Integer getComplianceReportId() {
        return complianceReportId;
    }

    public void setComplianceReportId(Integer complianceReportId) {
